        ...
        <div class="row">
            ...
            <div class="col-md-8 mt-4">
                ...
                <table style="width:100%;text-align: center;border-collapse: collapse;" border="1"
                    ...
                    <tr>
                        <td colspan="8">
                            <p style="float: left; color:red" class="font-weight-bold">Tổng tiền:
            ...
            <div class="col-md-4 hinhthucthanhtoan">
                ...
                <input type="submit" value="Thanh toán ngay" name="redirect"
                    class="text-white bg-gradient-to-r from-blue-600 to-green-600 hover:from-pink-500 hover:to-yellow-500 focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
