<h4 class="mt-1 font-Georgia font-medium text-lg text-teal-1000 uppercase">Thông tin đơn hàng</h4>
<?php
	$code = $_GET['code'];
...
?>
<table class="table table-bordered" style="width:100%" border="1" style="border-collapse: collapse; ">
