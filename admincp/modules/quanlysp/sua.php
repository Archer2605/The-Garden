...
<h4 class="mt-5 bg-dark text-white p-3 ">Sửa đổi thông tin sản phẩm</h4>
<?php
while ($row = mysqli_fetch_array($query_sua_sp)) {
?>
<form class="mt-3 border p-3 border-dark" method="POST"
    action="modules/quanlysp/xuly.php?idsanpham=<?php echo $row['id_sanpham'] ?>" enctype="multipart/form-data">
    <div class="form-group">
        <label for="tensanpham">Tên sản phẩm</label>
        <input type="text" value="<?php echo $row['tensanpham'] ?>" class="form-control" id="tensanpham"
            name="tensanpham">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" id="tacgia" name="tacgia" rows="5	"><?php echo $row['tacgia'] ?></textarea>
    </div>
    <div class="form-group">
    ...
    <button type="submit" name="suasanpham" class="btn btn-primary mb-2">Cập nhật</button>
</form>
<?php
}
?>