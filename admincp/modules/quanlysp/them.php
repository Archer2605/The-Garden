<h4 class="mt-5 bg-dark text-white p-3">Thêm sản phẩm mới</h4>
<form class="mt-4 border p-3 border-dark mb-5" method="POST" action="modules/quanlysp/xuly.php"
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" id="tacgia" name="tacgia" rows="1	"></textarea>
    </div>
    <div class="form-group">
