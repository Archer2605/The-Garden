...
<body class="">
    <div class="bg-gradient-to-r from-teal-100 to-line-100">
        <?php
		session_start();
...
<script
    src="https://www.paypal.com/sdk/js?client-id=AWlDvrjaQSHlDA_ta9P3sva_XFlyFWkX6v3DYNWQTWhHgEtvbXEbqGBl4XxW8kaaReOWsJgVagq_HeaI&currency=USD">
</script>
<script>
paypal.Buttons({
    ...
    onApprove: function(data, actions) {
        ...
        return actions.order.capture().then(function(orderData) {
            ...
            window.location.replace(
                'http://localhost/garden/index.php?quanly=camon&thanhtoan=paypal');
    ...
    onCancle: function(data) {
        window.location.replace('http://localhost/garden/index.php?quanly=thongtinthanhtoan');
    }
